...
% pbaspect([16 1 1])
% subplot(3,1,1),hold on,...
%     plot(tr*T0,B0*sum(Bl,2)/Nx,'color',[0 .5 0],'LineWidth',2),...
%     ylabel('B (g/m^2)','FontSize',18),xlim([0,tr(end)*T0]),ylim([0,1.5]),pbaspect([16 1 1])
%     fill([0,.5,.5,0,],[0 0 1.5 1.5],[0,0,1],'FaceAlpha',0.1)
% subplot(3,1,2),hold on,...
%     plot(tr*T0,sum(Wl,2)/Nx*W0,'blue','LineWidth',1),...
%     ylabel('W (mm)','FontSize',18),xlim([0,tr(end)*T0]),ylim([0,35]),pbaspect([16 1 1])
%     fill([0,.5,.5,0,],[0 0 35 35],[0,0,1],'FaceAlpha',0.1)
% subplot(3,1,3),hold on,...
%     plot(tr*T0,H0*sum(Hl,2)/Nx,'cyan','LineWidth',1),...
%     ylabel('H (mm)','FontSize',18),xlim([0,tr(end)*T0]),ylim([0,20]),pbaspect([16 1 1])
